...
" shift+HJKL moves a lot in that direction
noremap H 5b
noremap J 5j
noremap K 5k
noremap L 5w
...
" space opens/closes the current fold
...
" Lots of python stuff happens in subdirectories; hint what the python root
" should be
autocmd FileType python let b:coc_root_patterns = ['.env', 'requirements.txt']
